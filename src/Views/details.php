...
<main class="px-20 py-8 bg-white rounded-xl">
    <h2 class="text-indigo-900 font-bold text-2xl mb-8">Detalhes do item</h2>
        ...
        <div class="my-2 flex flex-col justify-between">
            ...
            <div class="">
                <p class="text-sm text-gray-500">Link:
                    <a href="<?= $item->link ?>" class="font-bold text-indigo-900 hover:underline">Clique aqui</a>
                </p>
            </div>
